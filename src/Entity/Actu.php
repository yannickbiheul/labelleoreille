...
class Actu
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=User::class, mappedBy="actu")
     */
    private $users;

    /**
     * @ORM\ManyToOne(targetEntity=Image::class, inversedBy="actus")
     */
    private $image;

    /**
     * @ORM\ManyToOne(targetEntity=Commentaire::class, inversedBy="actus")
     */
